  ...
  head: [
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "BioimageVision, deep learning, computer vision, image processing, medical image analysis, optimization, biomedical,  biomedical image processing, image recognition, image segmentation, medical image analysis,深度学习、计算机视觉、图像处理、医学图像分析,优化,生物图像处理, 图像识别, 图像分割,医学影像分析",
      },
    ],
    // 百度统计
    [
